...
variable "vm_name" {
  type    = string
  default = "debian-12-12-x64-fr-server-template"
}
...
locals {
  template_description = "Debian 12.12 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
