...
variable "iso_url" {
  type    = string
  default = "https://cdimage.debian.org/cdimage/archive/11.5.0/amd64/iso-cd/debian-11.5.0-amd64-netinst.iso"
}
...
variable "vm_name" {
  type    = string
  default = "debian-11-5-x64-fr-server-template"
}
...
locals {
  template_description = "Debian 11.5 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
