variable "iso_checksum" {
  type    = string
  default = "sha256:27a346c74d8755516a4ad2057ea29c2450454f1a928628734f26e12b0b8120d7"
}
...
variable "iso_url" {
  type    = string
  default = "https://vault.almalinux.org/9.6/isos/x86_64/AlmaLinux-9.6-x86_64-minimal.iso"
}
...
variable "vm_name" {
  type    = string
  default = "almalinux-9-6-x64-fr-server-template"
}
...
locals {
  template_description = "Almalinux 9 template built ${legacy_isotime("2024-05-04 00:25:00")} username:password => localuser:password"
}
