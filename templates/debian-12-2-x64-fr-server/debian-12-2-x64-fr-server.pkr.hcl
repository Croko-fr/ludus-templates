...
variable "iso_url" {
  type    = string
  default = "https://cdimage.debian.org/cdimage/archive/12.2.0/amd64/iso-cd/debian-12.2.0-amd64-netinst.iso"
}
...
variable "vm_name" {
  type    = string
  default = "debian-12-2-x64-fr-server-template"
}
...
locals {
  template_description = "Debian 12.2 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
