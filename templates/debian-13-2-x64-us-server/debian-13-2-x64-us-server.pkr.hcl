...
variable "vm_name" {
  type    = string
  default = "debian-13-2-x64-us-server-template"
}
...
locals {
  template_description = "Debian 13.2 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
