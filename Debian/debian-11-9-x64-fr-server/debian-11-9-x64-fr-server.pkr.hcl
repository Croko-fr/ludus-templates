variable "iso_checksum" {
  type    = string
  default = "sha512:0194bd9b7476f26bc59569fe6439cb046ed747a47632fb5324cc3c294b8231b53e497ac6e216cef581b44dcfad8a76da4bd860f0d930cebe06ad2995b3cb812c"
}
...
variable "iso_url" {
  type    = string
  default = "https://cdimage.debian.org/cdimage/archive/11.9.0/amd64/iso-cd/debian-11.9.0-amd64-netinst.iso"
}
...
variable "vm_name" {
  type    = string
  default = "debian-11-9-x64-fr-server-template"
}
...
locals {
  template_description = "Debian 11.9 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
