variable "iso_checksum" {
  type    = string
  default = "sha512:0d3441e9557b6fd7d0ccc3355db20ecb5b047346f7470d735849b5fadd86f87eefb7ea15f0f185945a5a3b79553d9afe8f25d7c27fef24856e2b377cd371032d"
}
...
variable "vm_name" {
  type    = string
  default = "debian-11-11-x64-us-server-template"
}
...
locals {
  template_description = "Debian 11.11 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
