variable "iso_checksum" {
  type    = string
  default = "sha512:5f6aed67b159d7ccc1a90df33cc8a314aa278728a6f50707ebf10c02e46664e383ca5fa19163b0a1c6a4cb77a39587881584b00b45f512b4a470f1138eaa1801"
}
...
variable "vm_name" {
  type    = string
  default = "debian-11-0-x64-fr-server-template"
}
...
locals {
  template_description = "Debian 11.0 template built ${legacy_isotime("2006-01-02 03:04:05")} username:password => debian:debian"
}
